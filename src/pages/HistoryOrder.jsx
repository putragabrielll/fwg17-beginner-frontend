                ...
                <div className="flex-1 flex gap-4">
                    ...
                    <div className="w-[55%] flex flex-col gap-8">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className="flex gap-4 bg-gray-100 px-3 py-2 items-center">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex bg-gray-100 p-2 gap-4">
                                ...
                                <div className="flex-1 flex pt-2 flex-col gap-4">
                                    ...
                                    <span className="text-md font-semibold">23 January 20233</span>
                                </div>
                                <div className="flex flex-col pt-2 gap-4">
                                    ...
                                    <span className="text-md font-semibold">Idr 40.000</span>
                                </div>
                                <div className="flex flex-col pt-2 gap-4">
                                    <div className="flex items-center gap-2">
                                    ...
                                    <span className="px-1 py-1 bg-[#f9e2c8] border border-[#f9e2c8] text-[#FF8906] rounded-full text-xs">On Progress</span>
                                </div>
                            </div>
